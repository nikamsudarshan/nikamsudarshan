# Hi, I'm Sudarshan Nikam 👋

**Mechatronics & IT Engineering | Hardware Automation | AI Systems Builder**

I am a systems engineer specializing in bridging the gap between digital data and physical hardware. I build end-to-end automation pipelines, autonomous mechatronic systems, and AI-driven workflows.

### 🛠️ Technical Stack
* **Languages:** Python, C++, C, JavaScript/HTML/CSS
* **Hardware & Robotics:** Arduino (AVR), CNC Motion Control, I2C/SPI Protocols, Sensor Fusion
* **AI & Data:** LangChain, CrewAI, FAISS, n8n, Signal Processing
* **Tools & OS:** Linux (Arch/Ubuntu), Git, AutoCAD, AxiDraw CLI
